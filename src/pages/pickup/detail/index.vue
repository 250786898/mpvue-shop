<template>
  <div>
    <div class="card">
      <img
        src="https://bucketlejia.oss-cn-shenzhen.aliyuncs.com/wechatv01/deliverycode_card_bg@2x.png"
        class="card__bg"
      />
        ...
        <div class="card__shop-item">
          ...
          >
            <div class="weui-cell__hd">
              <img
                src="https://bucketlejia.oss-cn-shenzhen.aliyuncs.com/wechatv01/deliverycode_img_logo@2x.png"
              />
            </div>
      ...
      <div class="card__dt">
        <navigator url="/pages/pickup/instruction/main" class="weui-cell weui-cell_access">
          <div class="weui-cell__hd">
            <img
              src="https://bucketlejia.oss-cn-shenzhen.aliyuncs.com/wechatv01/deliverycode_icon_gifrbag@2x.png"
            />
          </div>
        ...
        <div class="weui-cell">
          <div class="weui-cell__hd">
            <img
              src="https://bucketlejia.oss-cn-shenzhen.aliyuncs.com/wechatv01/deliverycode_icon_gifrbag@2x(1).png"
            />
          </div>
          <div class="weui-cell__bd">提货时间：{{pickUpTime}}</div>
        </div>
      </div>
    </div>

    <img
      src="http://bucketlejia.oss-cn-shenzhen.aliyuncs.com/deliverycode_bg@2x.png"
      class="footer__bg"
      mode="widthFix"
    />
...
export default {
  ...
  computed: {
    ...
    pickUpTime() {
      // return 'aaaa'
      return this.result.pickupTime
        ? formatPickUpDate(this.result.pickupTime)
        : ''
    }
  },
  mounted() {
  ...
  methods: {
    ...
    findOrderStat() {
      Api.order
        .findOrderStat({ orderId: this.orderId })
        .then(res => {
    ...
    getOrderPickUpCodeDetail() {
      Api.order
        .orderPickUpCode({ orderId: this.orderId })
        .then(res => {
          if (res.code === Api.CODES.SUCCESS) {
            this.result = res.data
